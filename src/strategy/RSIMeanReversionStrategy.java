...
public class RSIMeanReversionStrategy implements Strategy {
    ...
    private final String strategyName = "RSI Mean Reversion Strategy";
    private final String strategyDescription = "Buys when RSI crosses below 30 (oversold), expecting a price bounce; "
            + "sells when RSI crosses above 70 (overbought), expecting a price decline.";
